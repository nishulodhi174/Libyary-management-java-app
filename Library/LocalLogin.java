...
public class LocalLogin extends JFrame implements ActionListener{
    JLabel l1,l2,l3;
    JButton b1,b2;
    JPanel p1,p2;
    Font f1,f2;
...
//                ResultSet res = obj1.stm.executeQuery(s);
                ...
                String s = "SELECT * FROM student WHERE username = ? AND password = ?";
                ...
                if(res.next()){
                    System.out.println("Local Section");
//                    new LocalSection().setVariable(true);
                    LocalSection lf = new LocalSection();
                    lf.setVisible(true);
